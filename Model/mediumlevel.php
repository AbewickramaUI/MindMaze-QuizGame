...
if ($input != $solution) {
    $score -= 200; // reduce by 200 for incorrect answer
}
...
<div  id="progress-bar-container">
  ...
  <h2 id="time-left-title" align="center" style="color: white;">Time remaining:  <span id="timer">40 seconds</span></h2>
  ...
  <script>
    ...
    function handleInput() {
      ...
      if (input.value == solution) {
        ...
        // end game if 4 incorrect attempts have been made
    if (numIncorrect >= 4) { 
      clearInterval(timer);
      ...
      return;
        ...
        if(score>=100)
        // If the answer is incorrect, decrement the score by 100 and update the scoreboard
		    score -= 200;
  ...
  let reductionFactor = numIncorrect / 5; // Reduce by 10% per incorrect answer
